...
(function localSiteControls() {
    var translations = {
        ...
        'Reach us by email, WhatsApp or Facebook': 'অ্যাপয়েন্টমেন্ট বা রোগ সম্পর্কিত যেকোনো জিজ্ঞাসার জন্য ইমেইল, হোয়াটসঅ্যাপ বা ফেসবুকের মাধ্যমে সরাসরি যোগাযোগ করতে পারেন। দ্রুত উত্তর পেতে হোয়াটসঅ্যাপ বা ফোন কল সবচেয়ে নির্ভরযোগ্য।',
